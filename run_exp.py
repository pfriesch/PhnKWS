...
for ep in range(N_ep):
    ...
    for tr_data in tr_data_lst:
        ...
        for ck in range(N_ck_tr):
            ...
            config_chunk_file = out_folder + '/exp_files/train_' + tr_data + '_ep' + format(ep, "03d") + '_ck' + format(
                ck, "02d") + '.cfg'

            # Write chunk-specific cfg file
            write_cfg_chunk(cfg_file, config_chunk_file, cfg_file_proto_chunk, pt_files, lst_file, info_file, 'train',
    ...
    for valid_data in valid_data_lst:
        ...
        for ck in range(N_ck_valid):
            ...
            # path of the list of features for this chunk
            lst_file = out_folder + '/exp_files/valid_' + valid_data + '_ep' + format(ep, "03d") + '_ck' + format(ck,
                                                                                                                  "02d") + '_*.lst'

            # paths of the output files
            info_file = out_folder + '/exp_files/valid_' + valid_data + '_ep' + format(ep, "03d") + '_ck' + format(ck,
                                                                                                                   "02d") + '.info'
...
for forward_data in forward_data_lst:
    ...
    for ck in range(N_ck_forward):
        ...
        # path of the list of features for this chunk
        lst_file = out_folder + '/exp_files/forward_' + forward_data + '_ep' + format(ep, "03d") + '_ck' + format(ck,
                                                                                                                  "02d") + '_*.lst'

        # output file
        info_file = out_folder + '/exp_files/forward_' + forward_data + '_ep' + format(ep, "03d") + '_ck' + format(ck,
                                                                                                                   "02d") + '.info'
        ...
        # Write chunk-specific cfg file
        write_cfg_chunk(cfg_file, config_chunk_file, cfg_file_proto_chunk, model_files, lst_file, info_file, 'forward',
