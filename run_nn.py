...
from utils import read_args_command_line, dict_fea_lab_arch, is_sequential_dict, compute_cw_max, model_init, \
...
for i in range(N_batches):
    ...
    # Forward input
    outs_dict = forward_model(fea_dict, lab_dict, arch_dict, model, nns, costs, inp, inp_out_dict, max_len, batch_size,
                              to_do, forward_outs)
