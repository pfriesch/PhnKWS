...
class MLPLayer(nn.Module):
    ...
    def __init__(self, input_dim, out_channels, dnn_drop, dnn_act, dnn_use_laynorm, dnn_use_batchnorm):
        ...
        # Linear operations
        self.wx = nn.Conv1d(input_dim,out_channels,)
    ...
    def forward(self, x):
        ...
        assert self.input_dim == channels
